          ...
          <div class="col-lg-12">
           <div class="bs-component">
            ...
            <div class="row">
              ...
              <div class="col-lg-4">
               <div class="card" style="margin: 20px 0px 20px 0px">
                <h5 class="card-header" style="background-color: #115650; color: #fff; size: 16px">GigaBook</h5>
               ...
               <div class="card-footer text-muted" style="background-color: #115650; color: #fff; size: 16px">
               </div>
             </div>
             </div>
               ...
               <div class="col-lg-4">
               <div class="card" style="margin: 20px 0px 20px 0px">
                <h5 class="card-header" style="background-color: #115650; color: #fff; size: 16px">League of Ads</h5>
                <div class="hover ehover6">
              ...
              <div class="col-lg-4">
               <div class="card" style="margin: 20px 0px 20px 0px">
                <h5 class="card-header" style="background-color: #115650; color: #fff; size: 16px">Broad Ripple Tickets</h5>
                <div class="hover ehover6">
            ...
            <div class="row">
              ...
              <div class="col-lg-4">
               <div class="card" style="margin: 20px 0px 20px 0px">
                <h5 class="card-header" style="background-color: #115650; color: #fff; size: 16px">ETA Tickets</h5>
                <div class="hover ehover6">
               ...
               <div class="col-lg-4">
               <div class="card" style="margin: 20px 0px 20px 0px">
                <h5 class="card-header" style="background-color: #115650; color: #fff; size: 16px">TV Startup</h5>
                <div class="hover ehover6">
              ...
              <div class="col-lg-4">
               <div class="card" style="margin: 20px 0px 20px 0px">
                <h5 class="card-header" style="background-color: #115650; color: #fff; size: 16px">Nate Trotter</h5>
                <div class="hover ehover6">
           ...
           <div class="row">
              ...
              <div class="col-lg-4">
               <div class="card" style="margin: 20px 0px 20px 0px">
                <h5 class="card-header" style="background-color: #115650; color: #fff; size: 16px">Dietitian</h5>
                <div class="hover ehover6">
               ...
               <div class="col-lg-4">
               <div class="card" style="margin: 20px 0px 20px 0px">
                <h5 class="card-header" style="background-color: #115650; color: #fff; size: 16px">Taxi</h5>
                <div class="hover ehover6">
              ...
              <div class="col-lg-4">
               <div class="card" style="margin: 20px 0px 20px 0px">
                <h5 class="card-header" style="background-color: #115650; color: #fff; size: 16px">Rentals</h5>
                <div class="hover ehover6">
              ...
              <div class="col-lg-4">
               <div class="card" style="margin: 20px 0px 20px 0px">
                <h5 class="card-header" style="background-color: #115650; color: #fff; size: 16px">Tattoo Shop</h5>
                <div class="hover ehover6">
