...
<html lang="en">
  <head>
   ...
   .bg {
    ...
    width: 100%;
    height: 100%;
    background-image: url(images/porf-bg.png);
...
.card {
    border: 1px solid #070a07 !important;
}
 </style>
  </head>
  <body class="bg">
          ...
          <div class="col-lg-12">
           <div class="bs-component">
            ...
            <div class="row">
              ...
              <div class="col-lg-4">
               <div class="card" style="margin: 20px 0px 20px 0px">
                <h5 class="card-header" style="background-color: #115001bd; color: #d4d4d4; font-size: 14px">GigaBook</h5>
               ...
               <div class="card-footer text-muted" style="background-color: #115001bd; color: #d4d4d4; size: 16px">
               </div>
             </div>
             </div>
               ...
               <div class="col-lg-4">
               <div class="card" style="margin: 20px 0px 20px 0px">
                <h5 class="card-header" style="background-color: #115001bd; color: #d4d4d4; font-size: 14px">League of Ads</h5>
                <div class="hover ehover6">
              ...
              <div class="col-lg-4">
               <div class="card" style="margin: 20px 0px 20px 0px">
                <h5 class="card-header" style="background-color: #115001bd; color: #d4d4d4; font-size: 14px">Broad Ripple Tickets</h5>
                <div class="hover ehover6">
            ...
            <div class="row">
              ...
              <div class="col-lg-4">
               <div class="card" style="margin: 20px 0px 20px 0px">
                <h5 class="card-header" style="background-color: #115001bd; color: #d4d4d4; font-size: 14px">ETA Tickets</h5>
                <div class="hover ehover6">
               ...
               <div class="col-lg-4">
               <div class="card" style="margin: 20px 0px 20px 0px">
                <h5 class="card-header" style="background-color: #115001bd; color: #d4d4d4; font-size: 14px">TV Startup</h5>
                <div class="hover ehover6">
              ...
              <div class="col-lg-4">
               <div class="card" style="margin: 20px 0px 20px 0px">
                <h5 class="card-header" style="background-color: #115001bd; color: #d4d4d4; font-size: 14px">Nate Trotter</h5>
                <div class="hover ehover6">
           ...
           <div class="row">
              ...
              <div class="col-lg-4">
               <div class="card" style="margin: 20px 0px 20px 0px">
                <h5 class="card-header" style="background-color: #115001bd; color: #d4d4d4; font-size: 14px">Dietitian</h5>
                <div class="hover ehover6">
               ...
               <div class="col-lg-4">
               <div class="card" style="margin: 20px 0px 20px 0px">
                <h5 class="card-header" style="background-color: #115001bd; color: #d4d4d4; font-size: 14px">Taxi</h5>
                <div class="hover ehover6">
              ...
              <div class="col-lg-4">
               <div class="card" style="margin: 20px 0px 20px 0px">
                <h5 class="card-header" style="background-color: #115001bd; color: #d4d4d4; font-size: 14px">Rentals</h5>
                <div class="hover ehover6">
              ...
              <div class="col-lg-4">
               <div class="card" style="margin: 20px 0px 20px 0px">
                <h5 class="card-header" style="background-color: #115001bd; color: #d4d4d4; font-size: 14px">Tattoo Shop</h5>
                <div class="hover ehover6">
